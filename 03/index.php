<?php
/*
 * Написать функцию, по заданному числу формирующее текстовое окончание по правилам русского языка
 * Главный критерий, возможность легко менять слова, например яблок, яблока, яблоко
 * пример окончаний для часов-минут
...
* вызовите функцию в цикле для чисел от 0 до 50 с яблоками
 */
